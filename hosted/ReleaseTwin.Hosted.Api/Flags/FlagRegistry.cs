...
/// <summary>
/// add-feature-flag-seam: the hosted view of the single feature-flag registry, <c>flags.json</c> at
/// the repo root (embedded here as <c>ReleaseTwin.Hosted.Api.Flags.flags.json</c>, same pattern as
/// <see cref="Plans.PlanCatalog"/>). Loaded and validated once at startup — a malformed registry
...
public sealed class FlagRegistry
{
    ...
    {
        const string resource = "ReleaseTwin.Hosted.Api.Flags.flags.json";
