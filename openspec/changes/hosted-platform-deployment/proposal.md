...
- Apply the existing DynamoDB table terraform (`hosted/terraform/main.tf`) against a real AWS account — the `ealejo` account (846136340491), not the shared/unrelated `quik.api.testing` account.
